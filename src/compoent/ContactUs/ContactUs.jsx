...
function ContactUs() {
    return (
        <>
        <div className=" container colorr rounded-3xl">
            <div className="row ">
            <div className="flex justify-center items-center lg:w-6/12 md:w-1/2 ">
                ...
                <div className="flex justify-center items-center lg:w-6/12 md:w-1/2 ">
                    <p className='text-pretty text-green-600   ms-20 text-2xl'>إنوم تك: هي شركة تهدف إلى تعزيز القيم الإسلامية من خلال تقديم محتوى تعليمي ومبتكر. نسعى لنشر المعرفة والمبادئ الإسلامية، مع التركيز على تعزيز الأخلاق والفضائل في المجتمع. من خلال منصتنا، نعمل على تيسير الوصول إلى المعلومات التي تساعد الأفراد على تطبيق هذه القيم في حياتهم اليومية</p>
                </div>
...
<h2 className='text-3xl font-bold text-center  text-green-600 colorr m-auto  rounded-full p-4'>قيمنا  </h2>
  ...
  <div className="row ">
    ...
    <img src={Groupt} alt="Groupt" className=' w-3/6 lg:mx-36  ml-14  py-5 text-center  rounded-2xl ' />
